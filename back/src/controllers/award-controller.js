...
const addAward = async (req, res, next) => {
    try {
        ...
        res.status(StatusCodes.CREATED).send(createAward);
    } catch (error) {
        next(error);
    }
};
...
const getMyAwards = async (req, res, next) => {
    try {
        ...
        res.status(StatusCodes.OK).json(award);
    } catch (error) {
        next(error);
    }
};
...
const updateAward = async (req, res, next) => {
    try {
        ...
        res.status(StatusCodes.CREATED).json(updatedAward);
    } catch (error) {
        next(error);
    }
};
...
const deleteAward = async (req, res, next) => {
    try {
        ...
        res.status(StatusCodes.NO_CONTENT).json(deletedAward);
    } catch (error) {
        next(error);
    }
};
